...
#Create a Random Forest to predict team
```{r}
modFitRf <- train( training$team ~., method = "rf", data=trainPC, na.action = na.omit)
...
```
This shows the model achieved 76% accuracy. 
The results show 79% correct.
